...
print_status() {
  ...
  echo -e "${GREEN}═══════════════════════════════════════════════${NC}"
  echo ""
  echo -e "  ${BLUE}S3 Console:${NC}  http://localhost:4566/_localstack/health"
  echo -e "  ${BLUE}S3 Bucket:${NC}   http://localhost:4566/areadev-directus-storage-dev-1"
  echo -e "  ${BLUE}PG Admin:${NC}    postgresql://directus:directus@localhost:5432/directus"
  echo ""
}
